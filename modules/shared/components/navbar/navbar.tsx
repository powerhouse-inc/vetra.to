...
function Navbar() {
  ...
  return (
    <header className="sticky top-0 mx-auto mt-3 flex min-h-9 max-w-[var(--container-width)] items-center justify-center rounded-3xl backdrop-blur-[7.5px] md:top-1.5 md:p-2.5">
